 ...
 */
public abstract class QuickAdapter<M, V> extends RecyclerView.Adapter<QuickAdapter.QuickViewHolder> implements View.OnClickListener {
    ...
    private static QuickAdapter.OnRecyclerViewItemClickListener onRecyclerViewItemClickListener;

    @NonNull
    @Override
    public QuickAdapter.QuickViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if (null != headViews.get(viewType)) {
            return new QuickAdapter.QuickViewHolder(headViews.get(viewType));
        } else if (null != footViews.get(viewType)) {
            return new QuickAdapter.QuickViewHolder(footViews.get(viewType));
        }
        return new QuickAdapter.QuickViewHolder(getDataBinding(parent.getContext(), parent, setItemLayoutID()));
    }


    @Override
    public void onBindViewHolder(@NonNull QuickAdapter.QuickViewHolder holder, int position) {
    ...
    public void setOnRecyclerViewItemClickListener(QuickAdapter.OnRecyclerViewItemClickListener onRecyclerViewItemClickListener) {
