...
public class HintDalogFragment extends NaviBaseHintDiaLogFragment {
    ...
    public HintDalogFragment(NaviBaseFragment naviBaseFragment, OnDalogFragtListener onDalogFragtListener) {
        this(naviBaseFragment, onDalogFragtListener, true);
    }


    public HintDalogFragment(NaviBaseFragment naviBaseFragment, OnDalogFragtListener onDalogFragtListener, boolean isFocusable) {
